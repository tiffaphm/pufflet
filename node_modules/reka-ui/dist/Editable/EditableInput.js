import { defineComponent, computed, onMounted, watch, nextTick, openBlock, createBlock, unref, mergeProps, withKeys, withCtx, renderSlot } from 'vue';
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Primitive), mergeProps({
        ...
        "data-readonly": unref(context).readonly.value ? "" : undefined,
        readonly: unref(context).readonly.value,
        "aria-label": "editable input",
        hidden: unref(context).autoResize.value ? undefined : !unref(context).isEditing.value,
        style: unref(context).autoResize.value ? { all: "unset", gridArea: "1 / 1 / auto / auto", visibility: !unref(context).isEditing.value ? "hidden" : undefined } : undefined,
