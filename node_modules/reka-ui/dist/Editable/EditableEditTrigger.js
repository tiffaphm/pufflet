  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Primitive), mergeProps(props, {
        "aria-label": "edit",
        "aria-disabled": unref(context).disabled.value ? "" : undefined,
        "data-disabled": unref(context).disabled.value ? "" : undefined,
        disabled: unref(context).disabled.value,
        type: _ctx.as === "button" ? "button" : undefined,
        hidden: unref(context).isEditing.value ? "" : undefined,
