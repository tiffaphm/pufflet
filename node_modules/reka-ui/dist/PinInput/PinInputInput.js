import { defineComponent, computed, watch, onMounted, onUnmounted, openBlock, createBlock, unref, withKeys, withCtx, renderSlot, nextTick } from 'vue';
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Primitive), {
        ...
        "data-complete": unref(context).isCompleted.value ? "" : undefined,
