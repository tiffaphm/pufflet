import { defineComponent, toRefs, openBlock, createBlock, resolveDynamicComponent, unref, withCtx, createVNode, renderSlot, createCommentVNode } from 'vue';
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(unref(rovingFocus) ? unref(_sfc_main$1) : unref(Primitive)), {
        "as-child": "",
        orientation: unref(rovingFocus) ? _ctx.orientation : undefined,
        dir: unref(dir),
        loop: unref(rovingFocus) ? unref(loop) : undefined
      }, {
        default: withCtx(() => [
