import { defineComponent, computed, onMounted, onUnmounted, openBlock, createBlock, unref, withModifiers, withKeys, withCtx, renderSlot } from 'vue';
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Primitive), {
        ...
        disabled: unref(itemContext).disabled.value || !unref(itemContext).isFocusable.value ? "" : undefined,
        "data-disabled": unref(itemContext).disabled.value || !unref(itemContext).isFocusable.value ? "" : undefined,
