import { defineComponent, ref, onMounted, openBlock, createBlock, unref, withKeys, withCtx, renderSlot, nextTick } from 'vue';
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Primitive), {
        ...
        "data-invalid": unref(context).isInvalidInput.value ? "" : undefined,
        onInput: handleInput,
        onKeydown: [
